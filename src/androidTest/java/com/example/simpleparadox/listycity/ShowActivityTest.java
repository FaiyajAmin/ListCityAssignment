...
public class ShowActivityTest {
    ...
    public ActivityTestRule<MainActivity> rule =
        ...
        public void checkSwitch()
        {
                ...
                solo.assertCurrentActivity("No Activity Switch", ShowActivity.class);
        ...
        public void checkNameCorrectness()
        {
                ...
                View view = listView.getChildAt(0);
                solo.clickOnView(view);
                TextView textview  = (TextView) solo.getView(R.id.textCityName);
...
//                solo.assertCurrentActivity("No Activity Switch", ShowActivity.class);
    ...
    public void checkBackButton()
    {
        ...
        solo.assertCurrentActivity("No Activity Switch", MainActivity.class);
